function [X,xest,idx_targets] = apply_OFC_DM_red(x0,x0est,Sigma0,omega_mot,omega_sen,A,B,H,nsteps,L_family,S_family,s_family)
%apply_OFC_DM_red simulates reaching movements controlled by a LQG
